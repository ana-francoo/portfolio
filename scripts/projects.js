...
spline
  ...
  .then(() => {
    spline.addEventListener('mouseDown', (e) => {
      ...
      if (e.target.id === '36cd4900-6db2-4ee9-907b-ca616fe038b0') { // hydropal container
        window.location.href = '/projects/hydropal';
      }
      if (e.target.id === 'a2e45591-e609-454a-8d50-6c9ce9b51a23') { // flockstock container
        window.location.href = '/projects/flockstock';
      }
      if (e.target.id === 'c8011817-a3db-46e7-99b6-bdfdc5cd30f9') { // uwpm podcast container
        window.location.href = '/projects/pmpodcast';
      }
      if (e.target.id === 'fda3728b-2047-455f-b65b-fb6f8b03cdf6') { // ml customer churn container
